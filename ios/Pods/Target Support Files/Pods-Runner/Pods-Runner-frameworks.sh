...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/amwal_pay/amwal_pay.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/device_info_plus/device_info_plus.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_amazonpaymentservices/flutter_amazonpaymentservices.framework"
